<?php
	...
	function arrisdesign_slider_scripts() {
	...
	add_action( 'wp_enqueue_scripts', 'arrisdesign_slider_scripts' );
	
	function arrisdesign_slider_template() {
					...
					<?php if ( has_post_thumbnail() ) : ?>	
						<li class="slide">
							...
							<div class="slide-info">
								...
								<span class="entry-meta"><?php arrisdesign_posted_on(); ?></span>
							</div>
